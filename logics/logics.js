...
const status_code_game = {
    ...
    generateAnswer: function() {
        ...
        while (arrayIndex.length < 4) {
            ...
            if (!arrayIndex.includes(randomNum) &&
    ...
    searchStatusCode: function(code) {
        const indexOfCode = codes_definitions.codes.indexOf(code)
        const testings = codes_definitions.codes.indexOf(404)
        const answer = codes_definitions.definitions[indexOfCode]
        return answer
    }
};
